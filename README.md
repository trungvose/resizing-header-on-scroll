...
Demo: http://trungk18.github.io/resize-header-on-scroll.html

In this template, I will show you have to create an animated fixed navigation that will resize on scroll and when you scroll down the page a bit, the header resizes smaller with CSS3 animations, and gets back bigger when you scroll back to the top with just simple CSS3 animation and jQuery.
...
Thanks for checking it out, and feel free to view the demo, fork and fix the source code then pull back to me.